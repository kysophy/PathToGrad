...
*   **Orchestration Layer (AI Agentic Layer)**
    ...
    *   **Responsibility:** Processes natural language inputs and utilizes a Model Context Protocol (MCP) to trigger specific internal tools (e.g., `check_prerequisites()`) rather than relying on internal LLM knowledge.
